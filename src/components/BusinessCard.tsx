...
const countryNames: Record<string, Record<string, string>> = {
    no: { NO: 'Norge', SE: 'Sverige', DK: 'Danmark', FI: 'Finland', DE: 'Tyskland', US: 'USA', GB: 'Storbritannia', FR: 'Frankrike', ES: 'Spania' },
    en: { NO: 'Norway', SE: 'Sweden', DK: 'Denmark', FI: 'Finland', DE: 'Germany', US: 'USA', GB: 'United Kingdom', FR: 'France', ES: 'Spain' },
    de: { NO: 'Norwegen', SE: 'Schweden', DK: 'Dänemark', FI: 'Finnland', DE: 'Deutschland', US: 'USA', GB: 'Großbritannien', FR: 'Frankreich', ES: 'Spanien' },
    fr: { NO: 'Norvège', SE: 'Suède', DK: 'Danemark', FI: 'Finlande', DE: 'Allemagne', US: 'États-Unis', GB: 'Royaume-Uni', FR: 'France', ES: 'Espagne' },
    es: { NO: 'Noruega', SE: 'Suecia', DK: 'Dinamarca', FI: 'Finlandia', DE: 'Alemania', US: 'Estados Unidos', GB: 'Reino Unido', FR: 'Francia', ES: 'España' }
};
            ...
            <div className="relative z-10 pointer-events-none">
                ...
                <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs md:text-sm text-gray-500 dark:text-gray-400 mb-4">
                    ...
                    <span className="flex items-center gap-1.5 hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
                        ...
                        {(locale && countryNames[locale] ? countryNames[locale][business.country_code] : business.country_code) || business.country_code}
                    </span>
